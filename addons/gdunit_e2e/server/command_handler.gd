## Command dispatch adapted from RandallLiuXin/godot-e2e at commit
## ae6219f6e758a0f29bd243c8f963417fe4d63c36 under Apache-2.0.
## The addon retains the pinned command surface and delegates serialization to
## its shared upstream-compatible E2ESerializer primitive.

const JsonSerializer = preload("../protocol/e2e_serializer.gd")
